...
Invoke-WebRequest -Uri https://gist.githubusercontent.com/falkheiland/d221d84a7b2a383854747c127a612a89/raw/409d24311da6171c4ca5156e61d226d4aa2a449e/WindowsPowerShell%2520Microsoft.PowerShell_profile.ps1 -OutFile $ProfileFile -UseBasicParsing
@(
